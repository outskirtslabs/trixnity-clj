...
* Upgrade Trixnity to 5.7.0, add optional media download-size limits, and inherit upstream fixes for reactions, expired refresh-token logout, room display names, and cancelled-outbox media cleanup.
