...
{:deps {com.outskirtslabs/trixnity-clj
        {:git/url "https://github.com/outskirtslabs/trixnity-clj.git"
         :git/sha "f279fce88481396c60511cb57af71dd5de8e2222"}}}
----
...
For more focused examples, including Matrix space administration, see https://docs.outskirtslabs.com/ol.trixnity/next/examples[Examples].
