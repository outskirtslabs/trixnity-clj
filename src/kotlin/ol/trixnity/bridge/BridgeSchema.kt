...
internal object BridgeSchema {
    ...
    val passphrase: Keyword = Keyword.intern(schemaNamespace, "passphrase")
    ...
    val recoveryKey: Keyword = Keyword.intern(schemaNamespace, "recovery-key")
    val uia: Keyword = Keyword.intern(schemaNamespace, "uia")
    val completed: Keyword = Keyword.intern(schemaNamespace, "completed")
    val flows: Keyword = Keyword.intern(schemaNamespace, "flows")
    val session: Keyword = Keyword.intern(schemaNamespace, "session")
    val errorKind: Keyword = Keyword.intern(schemaNamespace, "error-kind")
    val errorMessage: Keyword = Keyword.intern(schemaNamespace, "error-message")
